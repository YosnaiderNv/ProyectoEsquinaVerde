    ...
    <section>
        <div class="mx-auto col-auto p-5" style="width: 50%;">
            <div class="px-lg-2 pt-lg-2 pb-lg-2 p-4 mb-auto w-100">
                <a href="index.php"><img src="" class="img-fluid" /></a>
            </div>
            <div class="align-self-center w-100 px-lg-8 py-lg-7 p-7">
                <h1 class="font-weight-bold mb-4">Crear un nuevo administrador</h1>
                <form class="mb-3" method="POST" action="../Variables/V_admin.php">
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control bg-teal-x border-0" id="exTel" placeholder="Ingresar teléfono" name="tel" pattern="[0-9]+" oninvalid="setCustomValidity('Solo números por favor.')" required="" />
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        <label for="exCA" class="form-label font-weight-bold">Código de administrador:</label>
                        <input type="text" class="form-control bg-teal-x border-0" id="exCA" placeholder="Ingresar Código" name="CA" pattern="[0-9]+" oninvalid="setCustomValidity('Solo números por favor.')" required="" />
                    </div>
                    <div class="mb-4">
